...
export default function APITestPage() {
  ...
  const apiEndpoints = [
    ...
    { name: 'Market Indices Config', endpoint: '/api/admin/market-config/indices', method: 'GET' },
    { name: 'Cryptocurrencies Config', endpoint: '/api/admin/market-config/cryptos', method: 'GET' },
    { name: 'Commodities Config', endpoint: '/api/admin/market-config/commodities', method: 'GET' },
    { name: 'Currency Pairs Config', endpoint: '/api/admin/market-config/currencies', method: 'GET' },
    { name: 'Market Auto-Update Status', endpoint: '/api/market/auto-update', method: 'GET' },
    { name: 'Market Indices Data', endpoint: '/api/market/country/US', method: 'GET' },
    { name: 'Cryptocurrencies Data', endpoint: '/api/market/crypto', method: 'GET' },
    { name: 'Currency Rates Data', endpoint: '/api/market/currencies', method: 'GET' },
    { name: 'Commodities Data', endpoint: '/api/market/commodities', method: 'GET' },
    {
