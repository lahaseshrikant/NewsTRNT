// src/lib/config.ts - Environment-based configuration for seamless scaling
export const config = {
...
// Tier-specific configurations for automatic scaling
...
export const getCurrentTier = () => {
  const tier = process.env.PLAN_TIER || 'free'
