...
const ROLE_QUICK_ACTIONS: Record<UserRole, QuickAction[]> = {
  SUPER_ADMIN: [
    { label: 'System Settings', href: '/admin/system', icon: '⚙️', description: 'Configure system', color: 'from-purple-500 to-pink-500' },
    { label: 'Team Management', href: '/admin/users/team', icon: '👥', description: 'Manage team', color: 'from-blue-500 to-cyan-500' },
    { label: 'Security', href: '/admin/system/security', icon: '🔐', description: 'Security settings', color: 'from-red-500 to-orange-500' },
    { label: 'Backup', href: '/admin/system/backup', icon: '💾', description: 'Backup data', color: 'from-green-500 to-emerald-500' },
  ],
  ADMIN: [
    { label: 'New Article', href: '/admin/content/new', icon: '✍️', description: 'Create article', color: 'from-blue-500 to-purple-500' },
    { label: 'Users', href: '/admin/users', icon: '👥', description: 'Manage users', color: 'from-green-500 to-emerald-500' },
    { label: 'Analytics', href: '/admin/analytics', icon: '📊', description: 'View stats', color: 'from-orange-500 to-red-500' },
    { label: 'Newsletter', href: '/admin/newsletter', icon: '📧', description: 'Send emails', color: 'from-cyan-500 to-blue-500' },
  ],
  EDITOR: [
    { label: 'New Article', href: '/admin/content/new', icon: '✍️', description: 'Create article', color: 'from-blue-500 to-purple-500' },
    { label: 'Articles', href: '/admin/content/articles', icon: '📄', description: 'Manage articles', color: 'from-green-500 to-emerald-500' },
    { label: 'Web Stories', href: '/admin/content/web-stories', icon: '📱', description: 'Create stories', color: 'from-pink-500 to-rose-500' },
    { label: 'Moderation', href: '/admin/moderation', icon: '💬', description: 'Moderate content', color: 'from-orange-500 to-amber-500' },
  ],
  AUTHOR: [
    { label: 'New Draft', href: '/admin/content/new', icon: '✍️', description: 'Start writing', color: 'from-blue-500 to-purple-500' },
    { label: 'My Drafts', href: '/admin/content/drafts', icon: '📝', description: 'View drafts', color: 'from-green-500 to-emerald-500' },
    { label: 'Media', href: '/admin/media', icon: '🖼️', description: 'Upload media', color: 'from-pink-500 to-rose-500' },
    { label: 'My Stats', href: '/admin/analytics', icon: '📊', description: 'View performance', color: 'from-orange-500 to-amber-500' },
  ],
  MODERATOR: [
    { label: 'Comments', href: '/admin/moderation', icon: '💬', description: 'Review comments', color: 'from-blue-500 to-cyan-500' },
    { label: 'Reports', href: '/admin/moderation/reports', icon: '⚠️', description: 'Handle reports', color: 'from-red-500 to-orange-500' },
    { label: 'Spam', href: '/admin/moderation/spam', icon: '🚫', description: 'Filter spam', color: 'from-gray-500 to-slate-500' },
    { label: 'Users', href: '/admin/users', icon: '👤', description: 'User actions', color: 'from-green-500 to-emerald-500' },
  ],
  VIEWER: [
    { label: 'Analytics', href: '/admin/analytics', icon: '📊', description: 'View analytics', color: 'from-blue-500 to-purple-500' },
    { label: 'Traffic', href: '/admin/analytics/traffic', icon: '🌐', description: 'Traffic data', color: 'from-green-500 to-emerald-500' },
    { label: 'Content', href: '/admin/content', icon: '📄', description: 'Browse content', color: 'from-orange-500 to-amber-500' },
    { label: 'Export', href: '/admin/analytics/export', icon: '📥', description: 'Export data', color: 'from-cyan-500 to-blue-500' },
  ],
};
    ...
    <div className="p-6 space-y-6">
          ...
          <div className="bg-card border border-border rounded-xl p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 rounded-lg bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800">
                ...
                <Link href="/admin/content/drafts" className="text-xs text-blue-600 hover:underline">View</Link>
              </div>
              ...
              <PermissionGate permission="comments.moderate">
                <div className="flex items-center justify-between p-3 rounded-lg bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800">
                  ...
                  <Link href="/admin/moderation" className="text-xs text-blue-600 hover:underline">Moderate</Link>
                </div>
              </PermissionGate>
              ...
              <PermissionGate permission="reports.view">
                <div className="flex items-center justify-between p-3 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
                  ...
                  <Link href="/admin/moderation/reports" className="text-xs text-blue-600 hover:underline">Review</Link>
                </div>
              </PermissionGate>
            </div>
          </div>
      ...
      <SuperAdminOnly>
        <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border border-purple-200 dark:border-purple-800 rounded-xl p-6">
          ...
          <div className="mt-4 flex gap-3">
            <Link href="/admin/system" className="text-sm text-purple-600 hover:underline">System Settings →</Link>
            <Link href="/admin/system/logs" className="text-sm text-purple-600 hover:underline">View Logs →</Link>
          </div>
        </div>
      </SuperAdminOnly>
      ...
      <AdminOnly>
        <div className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6">
          ...
          <div className="mt-4">
            <Link href="/admin/users/team" className="text-sm text-blue-600 hover:underline">Manage Team →</Link>
          </div>
        </div>
      </AdminOnly>
    </div>
