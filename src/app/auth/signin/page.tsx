  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-purple-200 dark:bg-purple-800/50 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-float"></div>
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <form className="mt-8 space-y-6 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl p-8 rounded-2xl shadow-2xl border border-white/20 dark:border-gray-700/30 hover:shadow-purple-200/50 dark:hover:shadow-blue-500/20 transition-all duration-500 animate-slide-in" onSubmit={handleSubmit}>
          ...
          {error && (
            <div className="bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 text-red-700 px-4 py-3 rounded-2xl text-sm shadow-lg animate-shake">
              ❌ {error}
            </div>
          )}
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="text-sm">
              <Link href="/auth/forgot-password" className="font-medium bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent hover:from-blue-600 hover:to-purple-600 transition-all duration-300 underline decoration-wavy hover:scale-105 inline-block">
                Forgot password? 🤔
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            >
              ...
              {isLoading ? 'Welcome back! Almost there... ✨' : 'Sign in & Get Started! 🎉'}
            </button>
          </div>
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <button
                type="button"
                className="group w-full inline-flex justify-center items-center py-3 px-4 border border-gray-200 rounded-2xl shadow-sm bg-white/90 text-sm font-semibold text-gray-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-blue-100 focus:outline-none focus:ring-4 focus:ring-blue-500/30 transition-all duration-300 transform hover:scale-105 hover:shadow-lg backdrop-blur-sm"
              >
              ...
              <button
                type="button"
                className="group w-full inline-flex justify-center items-center py-3 px-4 border border-gray-200 rounded-2xl shadow-sm bg-white/90 text-sm font-semibold text-gray-700 hover:bg-gradient-to-r hover:from-gray-50 hover:to-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-500/30 transition-all duration-300 transform hover:scale-105 hover:shadow-lg backdrop-blur-sm"
              >
                <svg className="w-5 h-5 group-hover:animate-bounce-gentle" fill="#1f2328" viewBox="0 0 24 24">
