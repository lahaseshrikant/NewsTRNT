...
const SecureLoginForm = ({ onAttempt, attemptsRemaining, isLocked }: SecureLoginFormProps) => {
 ...
 {/* Main login form */}
 <div className="bg-[#2a2926] rounded-xl border border-[#3a3835] p-8 shadow-lg">
 {/* Header */}
 ...
 <div className="flex justify-center space-x-4 text-xs text-[rgb(var(--muted-foreground))]">
