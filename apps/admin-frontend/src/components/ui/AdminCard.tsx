  ...
  return (
    <div
      ...
      className={`
        ...
        ${paddingMap[padding]}
        ${hover ? 'hover:shadow-editorial-lg hover:border-border/80 transition-all duration-200 cursor-pointer' : ''}
      ...
      <div className="flex items-start justify-between">
        ...
        {icon && (
          <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
            ...
            isNegative ? 'bg-red-50 text-red-500 dark:bg-red-950/50 dark:text-red-400' :
