...
const variantClasses: Record<BadgeVariant, string> = {
 default:'bg-[rgb(var(--muted))]/10 text-[rgb(var(--foreground))]',
 primary:'bg-primary/10 text-[rgb(var(--primary))]',
 ...
 outline:'border border-[rgb(var(--border))] text-[rgb(var(--muted-foreground))] bg-transparent',
};
