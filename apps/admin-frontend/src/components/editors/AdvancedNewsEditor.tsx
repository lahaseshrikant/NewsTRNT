...
const ToolbarSection: React.FC<{ children: React.ReactNode; title?: string }> = ({ children, title }) => (
 <div
 className="flex items-center gap-1 px-2 py-1 bg-[rgb(var(--card))] rounded-lg shadow-sm border border-[rgb(var(--border))] transition-colors"
 title={title}
 >
 {children}
 </div>
...
const ToolbarButton: React.FC<{
 ...
 :'text-[rgb(var(--foreground))] hover:bg-[rgb(var(--muted))]/10 hover:text-[rgb(var(--foreground))]',
 primary:'bg-vermillion text-white hover:bg-vermillion/90 shadow-sm',
 secondary:'bg-[rgb(var(--muted))]/10 text-[rgb(var(--foreground))] hover:bg-[rgb(var(--muted))]/10/80'
 };
...
const MenuBar: React.FC<{ 
 ...
 <>
 {/* Main Toolbar */}
 <div className="flex flex-wrap items-center gap-2 p-4 bg-[rgb(var(--card))] border-b border-[rgb(var(--border))] transition-colors">
 ...
 <div className="bg-[rgb(var(--card))] p-6 rounded-xl shadow-sm max-w-md w-full mx-4 border border-[rgb(var(--border))] transition-colors">
 <div className="flex items-center justify-between mb-4">
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))]">Add Link</h3>
 <button
 ...
 className="w-full px-3 py-2 border border-[rgb(var(--border))] rounded-lg focus:ring-2 focus:ring-vermillion focus:border-transparent bg-[rgb(var(--background))] text-[rgb(var(--foreground))]"
 />
 </div>
 <div>
 <label className="block text-sm font-medium text-[rgb(var(--foreground))] mb-2">
 ...
 <button
 onClick={() => setShowLinkDialog(false)}
 className="px-4 py-2 text-[rgb(var(--muted-foreground))] bg-[rgb(var(--muted))]/10 rounded-lg hover:bg-[rgb(var(--muted))]/10/70 transition-colors"
 >
 Cancel
 </button>
 <button
 ...
 <div className="bg-[rgb(var(--card))] p-6 rounded-xl shadow-sm max-w-md w-full mx-4 border border-[rgb(var(--border))] transition-colors">
 <div className="flex items-center justify-between mb-4">
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))]">Insert Image</h3>
 <button
...
const AdvancedNewsEditor: React.FC<AdvancedNewsEditorProps> = ({ 
 ...
 codeBlock: {
 HTMLAttributes: {
 class:'bg-[rgb(var(--muted))]/10 p-4 rounded-lg font-mono text-sm overflow-x-auto',
 },
 }
 }),
 Underline,
 ...
 resizable: true,
 HTMLAttributes: {
 class:'border-collapse border border-[rgb(var(--border))] my-4',
 },
 }),
 TableRow,
 TableHeader.configure({
 HTMLAttributes: {
 class:'bg-[rgb(var(--muted))]/10 font-semibold',
 },
 }),
 TableCell.configure({
 HTMLAttributes: {
 class:'border border-[rgb(var(--border))] p-2 min-w-[100px]',
 },
 }),
 Gapcursor,
 ...
 if (!editor) {
 return (
 <div className="border border-[rgb(var(--border))]/60 rounded-xl bg-[rgb(var(--card))] p-8">
 <div className="flex items-center justify-center">
 <div className="w-8 h-8 border-2 border-vermillion border-t-transparent rounded-full animate-spin"></div>
 <span className="ml-3 text-[rgb(var(--foreground))]">Loading advanced editor...</span>
 </div>
 </div>
 );
 }
 ...
 return (
 <div className={`border border-[rgb(var(--border))] rounded-xl overflow-hidden bg-[rgb(var(--card))] shadow-lg transition-all duration-300 ${disabled ?'opacity-60 pointer-events-none' :''}`}>
 {/* Toolbar */}
 {!focusMode && (
 <MenuBar 
 editor={editor} 
 ...
 [&_.ProseMirror]:text-[rgb(var(--foreground))] [&_.ProseMirror]:min-h-[380px]
 [&_.ProseMirror_h1]:text-[rgb(var(--foreground))] [&_.ProseMirror_h1]:text-4xl [&_.ProseMirror_h1]:font-bold [&_.ProseMirror_h1]:mt-8 [&_.ProseMirror_h1]:mb-6
 [&_.ProseMirror_h2]:text-[rgb(var(--foreground))] [&_.ProseMirror_h2]:text-2xl [&_.ProseMirror_h2]:font-bold [&_.ProseMirror_h2]:mt-6 [&_.ProseMirror_h2]:mb-3
 [&_.ProseMirror_h3]:text-[rgb(var(--foreground))] [&_.ProseMirror_h3]:text-xl [&_.ProseMirror_h3]:font-bold [&_.ProseMirror_h3]:mt-4 [&_.ProseMirror_h3]:mb-2
 [&_.ProseMirror_h4]:text-[rgb(var(--foreground))] [&_.ProseMirror_h4]:text-lg [&_.ProseMirror_h4]:font-semibold [&_.ProseMirror_h4]:mt-3 [&_.ProseMirror_h4]:mb-2
 [&_.ProseMirror_h5]:text-[rgb(var(--foreground))] [&_.ProseMirror_h5]:text-base [&_.ProseMirror_h5]:font-semibold [&_.ProseMirror_h5]:mt-3 [&_.ProseMirror_h5]:mb-1
 [&_.ProseMirror_h6]:text-[rgb(var(--foreground))] [&_.ProseMirror_h6]:text-sm [&_.ProseMirror_h6]:font-semibold [&_.ProseMirror_h6]:uppercase [&_.ProseMirror_h6]:tracking-wide [&_.ProseMirror_h6]:mt-2 [&_.ProseMirror_h6]:mb-1
 [&_.ProseMirror_ul]:list-disc [&_.ProseMirror_ul]:pl-6
 [&_.ProseMirror_ol]:list-decimal [&_.ProseMirror_ol]:pl-6
 [&_.ProseMirror_li]:text-[rgb(var(--foreground))] [&_.ProseMirror_li]:mb-1
 [&_.ProseMirror_strong]:text-[rgb(var(--foreground))] [&_.ProseMirror_strong]:font-bold
 [&_.ProseMirror_em]:text-[rgb(var(--foreground))] [&_.ProseMirror_em]:italic
 [&_.ProseMirror_p]:text-[rgb(var(--foreground))] [&_.ProseMirror_p]:leading-relaxed
 ...
 className="absolute top-4 right-4 p-2 bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-lg shadow-sm hover:shadow-sm transition-all"
 ...
 {/* Status Bar */}
 {!focusMode && (
 <div className="px-6 py-3 bg-[rgb(var(--muted))]/10 border-t border-[rgb(var(--border))]">
 ...
 wordProgress >= 100 ?'bg-green-500' : wordProgress >= 75 ?'bg-vermillion' :'bg-[rgb(var(--muted-foreground))]/60'
 }`}
