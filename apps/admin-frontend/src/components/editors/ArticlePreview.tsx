...
const ArticlePreview: React.FC<ArticlePreviewProps> = ({
 ...
 {/* Title */}
 <h1 className="text-4xl md:text-5xl font-bold text-[rgb(var(--foreground))] mb-4 leading-tight">
 {title ||'Untitled Article'}
 </h1>

 {/* Summary */}
 {summary && (
 <p className="text-xl text-[rgb(var(--muted-foreground))] leading-relaxed mb-6">
 {summary}
 </p>
 )}

 {/* Meta Info */}
 <div className="flex items-center text-[rgb(var(--muted-foreground))] text-sm mb-6">
 ...
 <span
 key={index}
 className="px-3 py-1 bg-[rgb(var(--muted))]/10 hover:bg-[rgb(var(--muted))]/10/80 text-[rgb(var(--foreground))] rounded-full text-sm font-medium transition-colors cursor-pointer"
 >
 #{tag}
 </span>
 ))}
 ...
 <div className="mt-12 p-6 bg-[rgb(var(--muted))]/10 rounded-xl border border-[rgb(var(--border))]">
