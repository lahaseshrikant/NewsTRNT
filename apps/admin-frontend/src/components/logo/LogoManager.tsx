...
<body class="bg-[rgb(var(--muted))]/30 flex items-center justify-center min-h-screen">
 ...
 <div class="absolute top-1 left-1 w-1 h-1 bg-[rgb(var(--card))] rounded-full animate-pulse animation-delay-100"></div>
 ...
 const gradientPresets = ['linear-gradient(135deg, #2563eb 0%, #4338ca 50%, #7c3aed 100%)','linear-gradient(135deg, #059669 0%, #10b981 50%, #34d399 100%)','linear-gradient(135deg, #dc2626 0%, #ea580c 50%, #d97706 100%)','linear-gradient(135deg, #7c3aed 0%, #a855f7 50%, #c084fc 100%)','linear-gradient(135deg, #1e40af 0%, #3b82f6 50%, #60a5fa 100%)','linear-gradient(135deg, #92400e 0%, #d97706 50%, #fbbf24 100%)','linear-gradient(135deg, #16a34a 0%, #22c55e 50%, #4ade80 100%)','linear-gradient(135deg, #be123c 0%, #e11d48 50%, #f43f5e 100%)'
 ];
 ...
 <div className="absolute top-1 left-1 w-1 h-1 bg-[rgb(var(--card))] rounded-full animate-ping animation-delay-100"></div>
 ...
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-lg p-6 mb-8">
 <h2 className="text-2xl font-bold text-[rgb(var(--foreground))] mb-4 text-center">
 ?? Current Active Logo
 </h2>
 ...
 <div className="text-sm text-[rgb(var(--muted-foreground))] text-center">
 ...
 <div className="bg-[rgb(var(--muted))]/20 rounded-lg p-4 min-w-64">
 <h3 className="font-semibold text-[rgb(var(--foreground))] mb-3">Logo Details</h3>
 <div className="space-y-2 text-sm">
 <div className="flex justify-between">
 <span className="text-[rgb(var(--muted-foreground))]">Type:</span>
 ...
 <div className="flex justify-between">
 <span className="text-[rgb(var(--muted-foreground))]">Last Updated:</span>
 ...
 {/* Quick Actions */}
 <div className="flex flex-wrap justify-center gap-3 mt-6 pt-4 border-t border-[rgb(var(--border))]">
 <button
 onClick={editCurrentLogo}
 className="px-4 py-2 bg-[rgb(var(--primary))] text-white rounded-lg hover:opacity-90 transition-colors font-medium text-sm"
 >
 ?? Edit Current Logo
 </button>
 <button
 ...
 alert('?? This active logo is already in your history.');
 }
 }}
 ...
 <div className="bg-[rgb(var(--card))] rounded-lg p-1 shadow-lg">
 {[
 ...
 :'text-[rgb(var(--muted-foreground))] hover:bg-[rgb(var(--muted))]/30 dark:hover:opacity-80'
 }`}
 >
 ...
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-lg p-6 sticky top-6">
 <h3 className="text-xl font-bold text-[rgb(var(--foreground))] mb-4 text-center">
 ...
 <div className="flex justify-center items-center h-40 bg-[rgb(var(--muted))]/30 rounded-lg mb-4">
 ...
 <button
 onClick={saveLogo}
 className="px-4 py-2 bg-[rgb(var(--primary))] text-white rounded-lg hover:opacity-90 transition-colors text-sm"
 >
 ...
 className="px-4 py-2 bg-[rgb(var(--muted))] text-[rgb(var(--foreground))] rounded-lg hover:opacity-80 transition-colors text-sm"
 >
 ? Cancel
 </button>
 )}
 ...
 {/* Logo Type Selection */}
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-lg p-6">
 <h3 className="text-xl font-bold text-[rgb(var(--foreground))] mb-4">Logo Type</h3>
 ...
 <div className="text-xs text-[rgb(var(--muted-foreground))]">Typography based</div>
 </button>
 ...
 <div className="text-xs text-[rgb(var(--muted-foreground))]">Geometric shapes</div>
 </button>
 ...
 <div className="text-xs text-[rgb(var(--muted-foreground))]">Upload image</div>
 </button>
 ...
 <div className="text-xs text-[rgb(var(--muted-foreground))]">Custom SVG/HTML</div>
 </button>
 </div>
 </div>
 ...
 {currentLogo.type ==='image' && (
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-lg p-6">
 <h3 className="text-xl font-bold text-[rgb(var(--foreground))] mb-4">Upload Image</h3>
 
 <div className="space-y-4">
 <div className="border-2 border-dashed border-[rgb(var(--border))] rounded-lg p-8 text-center hover:border-blue-400 transition-colors">
 <input
 ref={fileInputRef}
 type="file"
 accept="image/*"
 ...
 >
 <div className="text-4xl text-[rgb(var(--muted-foreground))]/70">??</div>
 <div className="text-lg font-medium text-[rgb(var(--muted-foreground))]">
 ...
 {currentLogo.type ==='code' && (
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-lg p-6">
 <h3 className="text-xl font-bold text-[rgb(var(--foreground))] mb-4">Custom Code</h3>
 ...
 className="px-3 py-2 border border-[rgb(var(--border))] rounded-lg bg-[rgb(var(--card))]"
 >
 ...
 className="w-full h-32 px-3 py-2 border border-[rgb(var(--border))] rounded-lg bg-[rgb(var(--card))] text-[rgb(var(--foreground))] font-mono text-sm"
 />
 ...
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-lg p-6">
 <h3 className="text-xl font-bold text-[rgb(var(--foreground))] mb-4">Basic Settings</h3>
 ...
 className="w-full px-3 py-2 border border-[rgb(var(--border))] rounded-lg bg-[rgb(var(--card))] text-[rgb(var(--foreground))]"
 maxLength={10}
 />
 </div>
 ...
 className="w-full h-10 border border-[rgb(var(--border))] rounded-lg"
 />
 </div>
 </div>
 </div>
 ...
 {(currentLogo.type ==='typography' || currentLogo.type ==='shape') && (
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-lg p-6">
 <h3 className="text-xl font-bold text-[rgb(var(--foreground))] mb-4">Shape</h3>
 ...
 className="w-full px-3 py-2 border border-purple-300 dark:border-purple-600 rounded-lg bg-[rgb(var(--card))] text-[rgb(var(--foreground))] font-mono text-sm"
 rows={2}
 />
 ...
 {currentLogo.type !=='image' && (
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-lg p-6">
 <h3 className="text-xl font-bold text-[rgb(var(--foreground))] mb-4">Background</h3>
 ...
 :'border-[rgb(var(--border))] hover:scale-105'
 }`}
 ...
 className="w-full px-3 py-2 border border-[rgb(var(--border))] rounded-lg bg-[rgb(var(--card))] text-[rgb(var(--foreground))] font-mono text-sm"
 rows={2}
 ...
 {/* Effects & Animation */}
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-lg p-6">
 <h3 className="text-xl font-bold text-[rgb(var(--foreground))] mb-4">Effects & Animation</h3>
 ...
 <label className="text-sm font-medium text-[rgb(var(--muted-foreground))]">
 ...
 :'bg-[rgb(var(--muted))]/30 text-[rgb(var(--muted-foreground))]'
 }`}
 >
 ...
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-lg p-6">
 <h3 className="text-xl font-bold text-[rgb(var(--foreground))] mb-4">Border & Shadow</h3>
 ...
 <div>
 <h3 className="text-xl font-bold text-[rgb(var(--foreground))]">Logo History & Versions</h3>
 ...
 className="px-3 py-2 bg-[rgb(var(--primary))] text-white rounded-lg hover:opacity-90 transition-colors text-sm font-medium"
 >
 ?? Save with Name
 </button>
 <button
 ...
 className="px-6 py-2 bg-[rgb(var(--primary))] text-white rounded-lg hover:opacity-90 transition-colors"
 >
 ...
 <div key={logo.id} className="group flex items-center justify-between p-4 border border-[rgb(var(--border))] rounded-lg hover:bg-[rgb(var(--muted))]/20 dark:hover:opacity-80 transition-colors">
 <div className="flex items-center space-x-4">
 {/* Logo Preview */}
 <div className="w-12 h-12 flex items-center justify-center rounded flex-shrink-0 bg-[rgb(var(--muted))]/30 border-2 border-[rgb(var(--border))]">
 {logo.dataUrl ? (
 ...
 className="flex-1 px-2 py-1 text-sm border border-[rgb(var(--border))] rounded bg-[rgb(var(--card))] text-[rgb(var(--foreground))]"
 onKeyPress={(e) => {
 if (e.key ==='Enter') {
 ...
 <>
 <h4 
 className="font-medium text-[rgb(var(--foreground))] cursor-pointer hover:text-blue-600 transition-colors"
 ...
 <button
 onClick={() => startEditingHistoryName(logo.id, logo.name)}
 className="text-[rgb(var(--muted-foreground))]/70 hover:text-[rgb(var(--foreground))] text-sm opacity-0 group-hover:opacity-100 transition-opacity"
 title="Edit name"
 >
 ??
 </button>
 ...
 <div className="text-xs text-[rgb(var(--muted-foreground))]/70 mt-1">
 ...
 className="px-3 py-1 bg-[rgb(var(--primary))] text-white rounded hover:opacity-90 transition-colors text-sm"
 ...
 className="px-3 py-1 bg-[rgb(var(--muted))] text-[rgb(var(--foreground))] rounded hover:opacity-80 transition-colors text-sm"
 ...
 <h4 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">
 ? Favorite Logos ({savedLogos.length})
 </h4>
 <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
 {savedLogos.slice(0, 6).map((logo) => (
 <div key={logo.id} className="p-3 border border-[rgb(var(--border))] rounded-lg hover:bg-[rgb(var(--muted))]/20 dark:hover:opacity-80 transition-colors">
 ...
 <span className="text-sm font-medium text-[rgb(var(--muted-foreground))] truncate">
 {logo.name.replace('Logo','')}
 </span>
 </div>
 <button
 onClick={() => loadLogo(logo)}
 className="w-full text-xs py-1 bg-[rgb(var(--muted))]/30 text-[rgb(var(--muted-foreground))] rounded hover:bg-[rgb(var(--muted))]/50 dark:hover:opacity-80 transition-colors"
 >
 Load
 </button>
 </div>
 ...
 {/* Quick Actions */}
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-lg p-6">
 <h3 className="text-xl font-bold text-[rgb(var(--foreground))] mb-4">Quick Deploy</h3>
 ...
 {/* Export Options */}
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-lg p-6">
 <h3 className="text-xl font-bold text-[rgb(var(--foreground))] mb-4">Export Options</h3>
 ...
 className="p-3 bg-[rgb(var(--muted))]/30 rounded-lg hover:bg-[rgb(var(--muted))]/50 dark:hover:opacity-80 transition-colors text-center"
 >
 ...
 {/* Generated Code */}
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-lg p-6">
 <h3 className="text-xl font-bold text-[rgb(var(--foreground))] mb-4">Generated React Component</h3>
 
 <div className="bg-[rgb(var(--muted))]/30 rounded-lg p-4 overflow-x-auto">
 <pre className="text-sm text-[rgb(var(--foreground))] whitespace-pre-wrap">
 {generateLogoCode()}
 </pre>
 </div>
 ...
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-3">?? Deployment Status</h3>
 <div className="space-y-2 text-sm">
 <div className="flex items-center justify-between">
 <span className="text-[rgb(var(--muted-foreground))]">Header Component:</span>
 <span className="text-green-600 dark:text-green-400 font-medium">? Dynamic Logo Active</span>
 </div>
 <div className="flex items-center justify-between">
 <span className="text-[rgb(var(--muted-foreground))]">Local Storage:</span>
 <span className="text-blue-600 font-medium">?? Auto-saving enabled</span>
 </div>
 <div className="flex items-center justify-between">
 <span className="text-[rgb(var(--muted-foreground))]">Cross-site Updates:</span>
 ...
 <div className="bg-[rgb(var(--card))] rounded-xl p-6 w-96 max-w-90vw">
 ...
 className="w-full px-4 py-2 border border-[rgb(var(--border))] rounded-lg bg-[rgb(var(--card))] text-[rgb(var(--foreground))] placeholder-[rgb(var(--muted-foreground))] focus:ring-2 focus:ring-blue-500 focus:border-transparent mb-4"
 autoFocus
 onKeyPress={(e) => {
 ...
 className="px-4 py-2 text-[rgb(var(--muted-foreground))] hover:text-[rgb(var(--foreground))] transition-colors"
 >
 Cancel
 </button>
 <button
 ...
 className="px-4 py-2 bg-[rgb(var(--primary))] text-white rounded-lg hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
 >
 Save Logo
 </button>
 </div>
