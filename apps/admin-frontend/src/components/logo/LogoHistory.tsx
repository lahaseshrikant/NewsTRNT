...
const LogoHistory = () => {
 ...
 <div className="absolute top-1 left-1 w-1 h-1 bg-[rgb(var(--card))] rounded-full animate-ping" style={{animationDelay:'100ms'}}></div>
 ...
 return'bg-[rgb(var(--muted))]/30 text-[rgb(var(--foreground))]';
 };
 ...
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-lg p-8">
 {/* Header */}
 <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-8 gap-4">
 <div>
 <h1 className="text-4xl font-bold text-[rgb(var(--foreground))] mb-2">
 ...
 {/* View Mode Toggle */}
 <div className="flex bg-[rgb(var(--muted))]/30 rounded-lg p-1">
 <button
 onClick={() => setPreviewMode('list')}
 className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${
 previewMode ==='list' 
 ?'bg-white text-[rgb(var(--foreground))] shadow-sm' 
 ...
 className="px-3 py-2 border border-[rgb(var(--border))] rounded-lg bg-[rgb(var(--card))] text-[rgb(var(--foreground))] text-sm"
 >
 ...
 <a
 href="/logo-manager"
 className="inline-block px-6 py-3 bg-[rgb(var(--primary))] text-white rounded-lg hover:opacity-90 transition-colors font-medium"
 >
 Go to Logo Manager
 </a>
 </div>
 ...
 <div className="text-xs text-[rgb(var(--muted-foreground))]">Total Versions</div>
 </div>
 <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-4 text-center">
 <div className="text-2xl font-bold text-green-600 dark:text-green-400 mb-1">
 {logoHistory.filter(logo => logo.config.type ==='image').length}
 </div>
 <div className="text-xs text-[rgb(var(--muted-foreground))]">Image Logos</div>
 </div>
 <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-4 text-center">
 <div className="text-2xl font-bold text-purple-600 dark:text-purple-400 mb-1">
 {logoHistory.filter(logo => logo.config.type ==='code').length}
 </div>
 <div className="text-xs text-[rgb(var(--muted-foreground))]">Code Logos</div>
 </div>
 <div className="bg-orange-50 dark:bg-orange-900/20 rounded-xl p-4 text-center">
 <div className="text-2xl font-bold text-orange-600 dark:text-orange-400 mb-1">
 {logoHistory.reduce((sum, logo) => sum + (logo.deployments || 0), 0)}
 </div>
 <div className="text-xs text-[rgb(var(--muted-foreground))]">Total Deployments</div>
 </div>
 ...
 <div className="text-xs text-[rgb(var(--muted-foreground))]">Latest Version</div>
 </div>
 </div>
 ...
 <div key={logo.id} className="group bg-[rgb(var(--muted))]/20 rounded-xl p-6 hover:bg-[rgb(var(--muted))]/30 dark:hover:opacity-80 transition-colors border border-[rgb(var(--border))]">
 {/* Preview */}
 ...
 <h3 
 className="font-semibold text-[rgb(var(--foreground))] cursor-pointer hover:text-blue-600 transition-colors mb-2"
 ...
 <div className="text-xs text-[rgb(var(--muted-foreground))]/70">
 ...
 {filteredHistory.map((logo, index) => (
 <div key={logo.id}>
 <div className="group flex items-center justify-between p-6 border border-[rgb(var(--border))] rounded-xl hover:bg-[rgb(var(--muted))]/20 dark:hover:opacity-80 transition-colors">
 ...
 value={editingHistoryName}
 onChange={(e) => setEditingHistoryName(e.target.value)}
 className="flex-1 px-3 py-2 text-lg border border-[rgb(var(--border))] rounded-lg bg-[rgb(var(--card))] text-[rgb(var(--foreground))]"
 onKeyPress={(e) => {
 if (e.key ==='Enter') saveHistoryNameEdit(logo.id);
 if (e.key ==='Escape') cancelEditingHistoryName();
 }}
 ...
 <>
 <h3 
 className="text-lg font-semibold text-[rgb(var(--foreground))] cursor-pointer hover:text-blue-600 transition-colors"
 onClick={() => startEditingHistoryName(logo.id, logo.name)}
 title="Click to edit name"
 >
 {logo.name}
 ...
 <button
 onClick={() => startEditingHistoryName(logo.id, logo.name)}
 className="text-[rgb(var(--muted-foreground))]/70 hover:text-[rgb(var(--foreground))] opacity-0 group-hover:opacity-100 transition-opacity"
 title="Edit name"
 >
 ✏️
 </button>
 ...
 <div className="text-[rgb(var(--muted-foreground))] mb-1 flex items-center space-x-4">
 ...
 <div className="text-sm text-[rgb(var(--muted-foreground))] flex items-center space-x-4">
 ...
 className="px-4 py-2 bg-[rgb(var(--primary))]/10 text-[rgb(var(--primary))] rounded-lg hover:bg-[rgb(var(--primary))]/20 transition-colors text-sm font-medium"
 >
 ...
 <div className="mx-6 mb-4 p-6 bg-blue-50 rounded-xl border border-blue-200">
 ...
 <h5 className="font-medium text-[rgb(var(--foreground))] mb-3">Live Preview</h5>
 ...
 {/* Technical Details */}
 <div>
 <h5 className="font-medium text-[rgb(var(--foreground))] mb-3">Technical Details</h5>
 ...
 {/* Usage Statistics */}
 <div>
 <h5 className="font-medium text-[rgb(var(--foreground))] mb-3">Usage Statistics</h5>
 <div className="space-y-2 text-sm">
 ...
 <div className="mt-6">
 <h5 className="font-medium text-[rgb(var(--foreground))] mb-3">Source Code</h5>
 <pre className="bg-[rgb(var(--card))] text-green-400 p-4 rounded-lg overflow-x-auto text-sm">
