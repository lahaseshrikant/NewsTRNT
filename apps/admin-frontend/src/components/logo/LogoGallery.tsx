...
const LogoGallery = () => {
 ...
 <span className="text-[rgb(var(--muted-foreground))]/70 text-sm">—</span>
 ...
 case'nn-angular':
 return (
 <div className="font-black text-2xl text-[rgb(var(--foreground))] transform skew-x-12">
 NN
 </div>
 );
 ...
 case'nn-thin':
 return (
 <div className="font-thin text-2xl text-[rgb(var(--muted-foreground))]">
 NN
 </div>
 );
 ...
 return (
 <div className="relative">
 <div className="w-8 h-6 bg-[rgb(var(--card))] flex items-center justify-center">
 ...
 <div className="absolute top-1 left-1 w-1 h-1 bg-[rgb(var(--card))] rounded-full animate-ping"></div>
 ...
 <div className="flex justify-center items-center space-x-2 text-sm text-blue-600 mb-4">
 ...
 <a 
 href="/logo-manager" 
 className="inline-flex items-center px-6 py-3 bg-[rgb(var(--primary))] text-white rounded-lg hover:opacity-90 transition-all transform hover:scale-105 shadow-lg"
 >
 🔒 Admin Logo Manager
 ...
 :'bg-[rgb(var(--card))] text-[rgb(var(--muted-foreground))] hover:bg-[rgb(var(--muted))]/30 dark:hover:opacity-80'
 }`}
 >
 {category}
 </button>
 ...
 <div
 key={logo.id}
 className="bg-[rgb(var(--card))] rounded-xl shadow-lg hover:shadow-sm transition-all duration-300 p-6"
 >
 ...
 <div className="inline-block px-2 py-1 bg-[rgb(var(--muted))]/30 rounded-full text-xs font-medium text-[rgb(var(--muted-foreground))] mb-3">
 {logo.category}
 </div>
 ...
 :'bg-[rgb(var(--primary))] hover:opacity-90 text-white'
 }`}
 >
 ...
 <div className="mt-12 bg-[rgb(var(--card))] rounded-xl shadow-lg p-8">
