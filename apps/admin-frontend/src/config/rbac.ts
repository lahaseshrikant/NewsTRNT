...
export const ADMIN_NAVIGATION: NavItem[] = [
 ...
 { id: 'user-team', label: 'Team Members', href: '/access/team', icon: 'users', requiredRole: 'SUPER_ADMIN' },
 ...
 { id: 'security', label: 'Security', href: '/access/security', icon: 'shield', requiredRole: 'SUPER_ADMIN' },
 ...
 { id: 'audit-logs', label: 'Audit Logs', href: '/access/audit', icon: 'document', requiredRole: 'SUPER_ADMIN' },
 ],
 },
