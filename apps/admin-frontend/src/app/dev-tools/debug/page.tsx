...
export default function DebugPage() {
 ...
 NODE_ENV: process.env.NODE_ENV ||'unknown','API_CONFIG.baseURL': API_CONFIG.baseURL,
 });
 };
 ...
 default: return'bg-[rgb(var(--muted-foreground))]/60 animate-pulse';
 }
 };
 ...
 default: return'bg-[rgb(var(--muted))]/5 border-[rgb(var(--border))]';
 }
 };
 ...
 <div>
 <h1 className="text-2xl sm:text-2xl font-semibold tracking-tight text-[rgb(var(--foreground))]">Debug & Diagnostics</h1>
 <p className="text-[rgb(var(--muted-foreground))] mt-1">System health checks, auth state, and environment info</p>
 </div>
 <button
 ...
 {/* Service Health */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl shadow-sm p-6 mb-6">
 <h2 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Service Health</h2>
 ...
 <p className="font-semibold text-[rgb(var(--foreground))] text-sm">{s.service}</p>
 <p className="text-xs text-[rgb(var(--muted-foreground))] truncate">{s.url}</p>
 </div>
 </div>
 <div className="mt-2 flex items-center gap-2 text-xs text-[rgb(var(--muted-foreground))]">
 ...
 {/* Auth State */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl shadow-sm p-6 mb-6">
 <h2 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Authentication State</h2>
 <div className="overflow-x-auto">
 <table className="w-full text-sm">
 <tbody>
 {Object.entries(authInfo).map(([key, value]) => (
 <tr key={key} className="border-b border-[rgb(var(--border))] last:border-0">
 <td className="py-2.5 pr-4 font-mono text-[rgb(var(--muted-foreground))] whitespace-nowrap">{key}</td>
 <td className="py-2.5 font-mono text-[rgb(var(--foreground))] break-all">
 ...
 {/* Environment */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl shadow-sm p-6 mb-6">
 <h2 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Environment Variables</h2>
 <div className="overflow-x-auto">
 <table className="w-full text-sm">
 <tbody>
 ...
 <tr key={key} className="border-b border-[rgb(var(--border))] last:border-0">
 <td className="py-2.5 pr-4 font-mono text-[rgb(var(--muted-foreground))] whitespace-nowrap">{key}</td>
 <td className="py-2.5 font-mono text-[rgb(var(--foreground))] break-all">{value}</td>
 </tr>
 ))}
 </tbody>
 </table>
 ...
 {/* Quick Actions */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl shadow-sm p-6">
 ...
 className="px-4 py-2 bg-[rgb(var(--primary))]/10 text-[rgb(var(--primary))] rounded-lg text-sm font-medium hover:bg-[rgb(var(--primary))]/20 transition-colors border border-[rgb(var(--primary))]/20"
 >
 API Test Dashboard
 </button>
 <button
