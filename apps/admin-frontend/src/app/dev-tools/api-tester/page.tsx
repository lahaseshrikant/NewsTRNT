...
export default function APITestPage() {
 ...
 <div className="mb-6">
 <h1 className="text-2xl font-semibold tracking-tight text-[rgb(var(--foreground))]">API Testing Dashboard</h1>
 <p className="mt-2 text-[rgb(var(--muted-foreground))]">Test all admin and market data API endpoints</p>
 </div>

 {/* Market Configuration Snapshot */}
 <div className="mb-6 bg-[rgb(var(--card))] rounded-lg shadow-sm border border-[rgb(var(--border))] overflow-hidden">
 <div className="px-6 py-4 bg-[rgb(var(--muted))] border-b border-[rgb(var(--border))] flex items-center justify-between">
 <div>
 ...
 <div className="bg-[rgb(var(--primary))]/5 rounded-lg border border-[rgb(var(--primary))]/20 p-4">
 <div className="text-sm text-[rgb(var(--primary))]">Currencies</div>
 <div className="text-2xl font-semibold text-[rgb(var(--primary))]">{configCounts.currencies}</div>
 </div>
 ...
 <details className="bg-[rgb(var(--muted))]/20 border border-[rgb(var(--border))] rounded-lg">
 ...
 <thead>
 <tr className="text-left text-xs uppercase text-[rgb(var(--muted-foreground))] bg-[rgb(var(--muted))]/30">
 ...
 <td className="px-3 py-2 text-right text-xs text-[rgb(var(--muted-foreground))]">
 {index.sortOrder}
 </td>
 </tr>
 ))}
 ...
 <div className="px-6 py-6 text-sm text-[rgb(var(--muted-foreground))]">
 ...
 testing
 ?'bg-[rgb(var(--muted-foreground))]/50 cursor-not-allowed text-[rgb(var(--muted-foreground))]'
 :'bg-[rgb(var(--primary))] hover:opacity-90 dark:hover:bg-[rgb(var(--primary))] text-white'
 }`}
 >
 ...
 disabled={testing}
 className="px-6 py-3 bg-[rgb(var(--muted-foreground))] hover:opacity-80 text-white rounded-lg font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed"
 >
 Clear Results
 </button>
 </div>
 ...
 {/* API Endpoints List */}
 <div className="bg-[rgb(var(--card))] rounded-lg shadow-sm overflow-hidden">
 <div className="px-6 py-4 bg-[rgb(var(--muted))] border-b border-[rgb(var(--border))]">
 <h2 className="text-lg font-semibold text-[rgb(var(--foreground))]">Available Endpoints</h2>
 </div>
 ...
 return (
 <div key={index} className="p-6 hover:bg-[rgb(var(--muted))]/20 transition">
 <div className="flex items-center justify-between mb-3">
 <div className="flex-1">
 <div className="flex items-center gap-3">
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))]">{api.name}</h3>
 <span className="px-2 py-1 text-xs font-semibold rounded bg-[rgb(var(--primary))]/10 text-[rgb(var(--primary))]">
 {api.method}
 </span>
 </div>
 <p className="text-sm text-[rgb(var(--muted-foreground))] font-mono mt-1">{api.endpoint}</p>
 </div>
 
 <button
 onClick={() => testSingleEndpoint(api.endpoint, api.method)}
 disabled={testing}
 className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 dark:bg-green-500 dark:hover:bg-emerald-600 text-white rounded-lg text-sm font-semibold transition disabled:bg-[rgb(var(--muted-foreground))]/60 disabled:cursor-not-allowed"
 >
 Test
 </button>
 </div>
 ...
 <summary className="text-sm font-semibold text-[rgb(var(--foreground))] mb-2">
 View Response
 </summary>
 <pre className="text-xs bg-[rgb(var(--card))] p-3 rounded border border-[rgb(var(--border))] overflow-auto max-h-64 text-[rgb(var(--foreground))]">
 {result.error 
 ? result.error
 ...
 <div className="mt-6 bg-[rgb(var(--card))] rounded-lg shadow-sm p-6">
 <h2 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Test Summary</h2>
