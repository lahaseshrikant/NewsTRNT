...
const EngagementAnalytics: React.FC = () => {
 ...
 {/* Header */}
 <div className="bg-gradient-to-r from-purple-600/10 to-pink-600/10 border-b border-[rgb(var(--border))]">
 ...
 <h2 className="text-2xl font-bold text-[rgb(var(--foreground))]">Engagement Overview</h2>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-[rgb(var(--muted-foreground))]">Comments</p>
 <p className="text-2xl font-bold text-[rgb(var(--foreground))]">{totalComments.toLocaleString()}</p>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-[rgb(var(--muted-foreground))]">Likes</p>
 <p className="text-2xl font-bold text-[rgb(var(--foreground))]">{totalLikes.toLocaleString()}</p>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-[rgb(var(--muted-foreground))]">Shares</p>
 <p className="text-2xl font-bold text-[rgb(var(--foreground))]">{totalShares.toLocaleString()}</p>
 ...
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Average Engagement Rate</h3>
 <div className="flex items-center space-x-4">
 <div className="text-4xl font-bold text-[rgb(var(--primary))]">{avgEngagementRate.toFixed(1)}%</div>
 ...
 {/* Top Engaged Users */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-lg p-6 mb-8">
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-6">Most Engaged Users</h3>
 <div className="overflow-x-auto">
 <table className="w-full">
 <thead className="bg-muted">
 <tr>
 <th className="p-4 text-left text-sm font-medium text-[rgb(var(--muted-foreground))]">User</th>
 <th className="p-4 text-left text-sm font-medium text-[rgb(var(--muted-foreground))]">Comments</th>
 <th className="p-4 text-left text-sm font-medium text-[rgb(var(--muted-foreground))]">Likes</th>
 <th className="p-4 text-left text-sm font-medium text-[rgb(var(--muted-foreground))]">Shares</th>
 <th className="p-4 text-left text-sm font-medium text-[rgb(var(--muted-foreground))]">Score</th>
 <th className="p-4 text-left text-sm font-medium text-[rgb(var(--muted-foreground))]">Interests</th>
 <th className="p-4 text-left text-sm font-medium text-[rgb(var(--muted-foreground))]">Last Activity</th>
 </tr>
 </thead>
 <tbody>
 {topEngagedUsers.map((user) => (
 <tr key={user.userId} className="border-t border-[rgb(var(--border))] hover:bg-[rgb(var(--muted))]/5">
 <td className="p-4">
 <div className="flex items-center space-x-3">
 <span className="text-2xl">{user.avatar}</span>
 <div>
 <div className="font-medium text-[rgb(var(--foreground))]">{user.username}</div>
 <div className="text-sm text-[rgb(var(--muted-foreground))]">User ID: {user.userId}</div>
 </div>
 </div>
 </td>
 <td className="p-4 text-[rgb(var(--foreground))]">{user.totalComments}</td>
 <td className="p-4 text-[rgb(var(--foreground))]">{user.totalLikes}</td>
 <td className="p-4 text-[rgb(var(--foreground))]">{user.totalShares}</td>
 <td className="p-4">
 <span className="bg-[rgb(var(--primary))]/10 text-[rgb(var(--primary))] px-2 py-1 rounded-full text-sm font-medium">
 ...
 <span key={category} className="bg-[rgb(var(--muted))]/10 text-[rgb(var(--muted-foreground))] px-2 py-1 rounded text-xs">
 {category}
 </span>
 ))}
 </div>
 ...
 <thead className="bg-muted">
 <tr>
 <th className="p-4 text-left text-sm font-medium text-[rgb(var(--muted-foreground))]">Article</th>
 <th className="p-4 text-left text-sm font-medium text-[rgb(var(--muted-foreground))]">Engagement Rate</th>
 <th className="p-4 text-left text-sm font-medium text-[rgb(var(--muted-foreground))]">Comments</th>
 <th className="p-4 text-left text-sm font-medium text-[rgb(var(--muted-foreground))]">Likes</th>
 <th className="p-4 text-left text-sm font-medium text-[rgb(var(--muted-foreground))]">Shares</th>
 <th className="p-4 text-left text-sm font-medium text-[rgb(var(--muted-foreground))]">Scroll Depth</th>
 <th className="p-4 text-left text-sm font-medium text-[rgb(var(--muted-foreground))]">Return Visitors</th>
 </tr>
 </thead>
 <tbody>
 ...
 <div className="text-lg font-semibold text-[rgb(var(--primary))]">{content.engagementRate}%</div>
 <div className="w-20 bg-[rgb(var(--muted))]/10 rounded-full h-2">
 <div 
 ...
 <span className="font-medium text-[rgb(var(--foreground))]">{content.comments}</span>
 </div>
 </td>
 <td className="p-4">
 <div className="flex items-center space-x-1">
 <span className="text-lg">❤️</span>
 <span className="font-medium text-[rgb(var(--foreground))]">{content.likes}</span>
 </div>
 </td>
 <td className="p-4">
 <div>
 <div className="font-medium text-[rgb(var(--foreground))]">{content.socialEngagement}</div>
 ...
 <td className="p-4">
 <div className="flex items-center space-x-2">
 <span className="text-[rgb(var(--foreground))]">{content.scrollDepth}%</span>
 <div className="w-16 bg-[rgb(var(--muted))]/10 rounded-full h-2">
 <div 
 ...
 <div className="flex items-center space-x-1">
 <span className="text-lg">🔄</span>
 <span className="font-medium text-[rgb(var(--foreground))]">{content.returnVisitors}</span>
 </div>
 </td>
 </tr>
 ))}
 ...
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-2">No engagement data found</h3>
