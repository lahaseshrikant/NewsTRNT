...
function RealtimeAnalyticsContent() {
 ...
 const colors = { up:'text-green-600', down:'text-red-600', stable:'text-[rgb(var(--muted-foreground))]' };
 return colors[trend];
 };
 ...
 <h1 className="text-2xl font-bold text-[rgb(var(--foreground))]">Real-Time Analytics</h1>
 </div>
 <p className="text-[rgb(var(--muted-foreground))]">Live visitor activity and engagement metrics</p>
 </div>
 <div className="flex items-center gap-4">
 <button
 onClick={fetchRealtimeData}
 className="px-3 py-1.5 rounded-lg text-sm bg-[rgb(var(--muted))]/10 hover:bg-[rgb(var(--muted))]/10/80 text-[rgb(var(--foreground))]"
 >
 Refresh
 </button>
 ...
 <p className="text-[rgb(var(--muted-foreground))] text-sm">Page Views/sec</p>
 <p className="text-4xl font-bold text-[rgb(var(--primary))]">{pageViewsPerSecond}</p>
 <p className="text-[rgb(var(--muted-foreground))] text-sm mt-1">requests per second</p>
 </div>
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <p className="text-[rgb(var(--muted-foreground))] text-sm">Avg. Session</p>
 <p className="text-4xl font-bold text-purple-600">{avgSession}</p>
 <p className="text-[rgb(var(--muted-foreground))] text-sm mt-1">minutes on site</p>
 </div>
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <p className="text-[rgb(var(--muted-foreground))] text-sm">Bounce Rate</p>
 <p className="text-4xl font-bold text-orange-600">{bounceRate}%</p>
 <p className="text-[rgb(var(--muted-foreground))] text-sm mt-1">single page visits</p>
 </div>
 </div>

 {/* Live Visitor Graph */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <h3 className="font-semibold text-[rgb(var(--foreground))] mb-4">Active Visitors (Last 10 updates)</h3>
 ...
 <div className="flex justify-between mt-2 text-xs text-[rgb(var(--muted-foreground))]">
 ...
 <h3 className="font-semibold text-[rgb(var(--foreground))]">Live Visitors</h3>
 <span className="text-xs text-[rgb(var(--muted-foreground))]">Updates every 2s</span>
 </div>
 <div className="divide-y divide-border max-h-[400px] overflow-y-auto">
 {liveVisitors.map(visitor => (
 <div key={visitor.id} className="p-3 hover:bg-[rgb(var(--muted))]/10/30 transition-colors">
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-3">
 <span className="text-xl">{visitor.countryFlag}</span>
 <div>
 <p className="text-sm font-medium text-[rgb(var(--foreground))] truncate max-w-[200px]">{visitor.page}</p>
 ...
 <p className="text-sm font-medium text-[rgb(var(--foreground))]">{formatDuration(visitor.duration)}</p>
 <p className="text-xs text-[rgb(var(--muted-foreground))]">{visitor.actions} actions</p>
 </div>
 </div>
 </div>
 ))}
 ...
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl overflow-hidden">
 <div className="p-4 border-b border-[rgb(var(--border))] flex items-center justify-between">
 <h3 className="font-semibold text-[rgb(var(--foreground))]">Trending Now</h3>
 <span className="text-xs text-[rgb(var(--muted-foreground))]">Top 5 articles</span>
 </div>
 <div className="divide-y divide-border">
 {trendingArticles.map((article, index) => (
 <div key={article.id} className="p-4 hover:bg-[rgb(var(--muted))]/10/30 transition-colors">
 <div className="flex items-start justify-between">
 <div className="flex items-start gap-3">
 <span className="text-2xl font-bold text-[rgb(var(--muted-foreground))]/50">#{index + 1}</span>
 <div>
 <p className="font-medium text-[rgb(var(--foreground))]">{article.title}</p>
 <p className="text-sm text-[rgb(var(--muted-foreground))]">{article.category}</p>
 </div>
 </div>
 <div className="text-right">
 <p className="font-bold text-[rgb(var(--foreground))]">{article.views.toLocaleString()}</p>
 ...
 {/* Traffic Sources */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <h3 className="font-semibold text-[rgb(var(--foreground))] mb-4">Traffic Sources</h3>
 <div className="space-y-3">
 {[
 { source:'Organic Search', percent: 42, color:'bg-green-500' },
 { source:'Direct', percent: 28, color:'bg-[rgb(var(--primary))]/50' },
 { source:'Social', percent: 18, color:'bg-purple-500' },
 { source:'Referral', percent: 8, color:'bg-orange-500' },
 { source:'Other', percent: 4, color:'bg-[rgb(var(--muted-foreground))]/80' },
 ].map(item => (
 <div key={item.source}>
 <div className="flex justify-between text-sm mb-1">
 <span className="text-[rgb(var(--foreground))]">{item.source}</span>
 <span className="text-[rgb(var(--muted-foreground))]">{item.percent}%</span>
 </div>
 <div className="h-2 bg-[rgb(var(--muted))]/10 rounded-full overflow-hidden">
 ...
 {/* Device Split */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <h3 className="font-semibold text-[rgb(var(--foreground))] mb-4">Device Split</h3>
 ...
 <div className="absolute inset-4 rounded-full bg-[rgb(var(--card))] flex items-center justify-center">
 <div className="text-center">
 <p className="text-2xl font-bold text-[rgb(var(--foreground))]">{activeVisitors}</p>
 <p className="text-xs text-[rgb(var(--muted-foreground))]">active</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <span className="w-3 h-3 bg-[rgb(var(--primary))]/50 rounded" />
 ...
 {/* Top Countries */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <h3 className="font-semibold text-[rgb(var(--foreground))] mb-4">Top Countries</h3>
 <div className="space-y-3">
 {[
 ...
 <span className="text-[rgb(var(--foreground))]">{item.country}</span>
 </div>
 <span className="font-medium text-[rgb(var(--foreground))]">{item.visitors}</span>
 </div>
 ))}
 </div>
 </div>
