...
const TrafficAnalytics: React.FC = () => {
 ...
 fetch(`${API_URL}/articles?limit=10&sortBy=viewCount&order=desc`, { headers: { ...adminAuth.getAuthHeaders() } })
 ]);
 ...
 <button className="px-4 py-2 bg-[rgb(var(--primary))] text-white rounded-xl hover:opacity-90 transition-colors duration-300">
 Export
 </button>
 </div>
 </div>
 ...
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-sm border border-[rgb(var(--border))]/50 p-6">
 <div className="flex items-center justify-between mb-2">
 <h3 className="text-sm font-semibold text-[rgb(var(--muted-foreground))]">Page Views</h3>
 <span className="text-2xl">👁️</span>
 </div>
 <div className="text-2xl font-semibold tracking-tight text-[rgb(var(--primary))]">{formatNumber(stats.pageViews)}</div>
 <div className="text-sm text-green-600 mt-1">↗+12.5% vs last period</div>
 </div>

 <div className="bg-[rgb(var(--card))] rounded-xl shadow-sm border border-[rgb(var(--border))]/50 p-6">
 <div className="flex items-center justify-between mb-2">
 <h3 className="text-sm font-semibold text-[rgb(var(--muted-foreground))]">Unique Visitors</h3>
 <span className="text-2xl">👥</span>
 </div>
 <div className="text-2xl font-semibold tracking-tight text-green-600">{formatNumber(stats.visitors)}</div>
 <div className="text-sm text-green-600 mt-1">↗+8.3% vs last period</div>
 </div>

 <div className="bg-[rgb(var(--card))] rounded-xl shadow-sm border border-[rgb(var(--border))]/50 p-6">
 <div className="flex items-center justify-between mb-2">
 <h3 className="text-sm font-semibold text-[rgb(var(--muted-foreground))]">Sessions</h3>
 <span className="text-2xl">🔄</span>
 </div>
 <div className="text-2xl font-semibold tracking-tight text-purple-600">{formatNumber(stats.sessions)}</div>
 <div className="text-sm text-green-600 mt-1">↗+15.2% vs last period</div>
 </div>

 <div className="bg-[rgb(var(--card))] rounded-xl shadow-sm border border-[rgb(var(--border))]/50 p-6">
 <div className="flex items-center justify-between mb-2">
 <h3 className="text-sm font-semibold text-[rgb(var(--muted-foreground))]">Bounce Rate</h3>
 <span className="text-2xl">📊</span>
 </div>
 <div className="text-2xl font-semibold tracking-tight text-orange-600">{stats.bounceRate.toFixed(1)}%</div>
 <div className="text-sm text-red-600 mt-1">↗+2.1% vs last period</div>
 </div>

 <div className="bg-[rgb(var(--card))] rounded-xl shadow-sm border border-[rgb(var(--border))]/50 p-6">
 <div className="flex items-center justify-between mb-2">
 <h3 className="text-sm font-semibold text-[rgb(var(--muted-foreground))]">Avg. Session</h3>
 <span className="text-2xl">⏱️</span>
 </div>
 <div className="text-2xl font-semibold tracking-tight text-indigo-600">{formatDuration(Math.round(stats.sessionDuration))}</div>
 <div className="text-sm text-green-600 mt-1">↗+5.7% vs last period</div>
 </div>
 </div>
 ...
 <h2 className="text-xl font-bold text-[rgb(var(--foreground))]">Traffic Trends</h2>
 <select
 ...
 <div className="w-16 text-xs text-[rgb(var(--muted-foreground))]">
 {new Date(day.date).toLocaleDateString('en-US', { weekday:'short' })}
 </div>
 <div className="flex-1 bg-[rgb(var(--muted))]/30 rounded-full h-6 relative">
 <div
 ...
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-sm border border-[rgb(var(--border))]/50">
 <div className="p-6 border-b border-[rgb(var(--border))]/50">
 <h2 className="text-xl font-bold text-[rgb(var(--foreground))]">Traffic Sources</h2>
 </div>
 <div className="p-6">
 ...
 />
 <span className="font-medium text-[rgb(var(--foreground))]">{source.source}</span>
 </div>
 <div className="text-right">
 <div className="font-bold text-[rgb(var(--foreground))]">{formatNumber(source.visitors)}</div>
 <div className="text-sm text-[rgb(var(--muted-foreground))]">{source.percentage}%</div>
 </div>
 </div>
 ))}
 </div>
 ...
 <div className="w-16 h-16 bg-[rgb(var(--card))] rounded-full flex items-center justify-center">
 <span className="text-sm font-bold text-[rgb(var(--foreground))]">Traffic</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-sm border border-[rgb(var(--border))]/50">
 <div className="p-6 border-b border-[rgb(var(--border))]/50">
 <h2 className="text-xl font-bold text-[rgb(var(--foreground))]">Top Pages</h2>
 </div>
 ...
 <tr key={page.page} className="hover:bg-[rgb(var(--background))] /50 transition-colors duration-200">
 <td className="px-6 py-4">
 <div className="flex items-center space-x-2">
 <span className="text-xs bg-[rgb(var(--primary))]/10 text-[rgb(var(--primary))] px-2 py-1 rounded">
 {index + 1}
 </span>
 <span className="font-medium text-[rgb(var(--foreground))] text-sm truncate max-w-xs">
 {page.page}
 </span>
 </div>
 </td>
 <td className="px-6 py-4 text-[rgb(var(--foreground))] font-semibold">
 ...
 {/* Real-time Stats */}
 <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-8 border border-[rgb(var(--border))]/50">
 <div className="flex items-center justify-between">
 <div>
 <h2 className="text-2xl font-bold text-[rgb(var(--foreground))] mb-2">Real-time Activity</h2>
 ...
 <div className="text-sm text-[rgb(var(--muted-foreground))]">Active users right now</div>
 </div>
 </div>
 <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
 <div className="text-center">
 <div className="text-2xl font-bold text-[rgb(var(--primary))]">34</div>
 <div className="text-sm text-[rgb(var(--muted-foreground))]">Reading articles</div>
 </div>
 <div className="text-center">
 <div className="text-2xl font-bold text-purple-600">23</div>
 <div className="text-sm text-[rgb(var(--muted-foreground))]">Browsing categories</div>
 </div>
 <div className="text-center">
 <div className="text-2xl font-bold text-orange-600">8</div>
 <div className="text-sm text-[rgb(var(--muted-foreground))]">On homepage</div>
 </div>
 </div>
 </div>
 </div>
