...
export default function AIProcessingPage() {
 ...
 <p className="text-[rgb(var(--muted-foreground))]/70 text-sm mt-1">AI provider status and processing tools</p>
 </div>

 {/* AI Status Cards */}
 <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
 <div className="bg-[#1a1a2e] rounded-xl border border-[rgb(var(--border))]/50 p-4">
 <div className="text-[rgb(var(--muted-foreground))]/70 text-xs mb-1">Provider</div>
 <div className="text-white font-semibold text-lg">{status?.provider ||'OpenAI'}</div>
 </div>
 <div className="bg-[#1a1a2e] rounded-xl border border-[rgb(var(--border))]/50 p-4">
 <div className="text-[rgb(var(--muted-foreground))]/70 text-xs mb-1">Model</div>
 <div className="text-purple-400 font-semibold text-lg">{status?.model ||'gpt-3.5-turbo'}</div>
 </div>
 <div className="bg-[#1a1a2e] rounded-xl border border-[rgb(var(--border))]/50 p-4">
 <div className="text-[rgb(var(--muted-foreground))]/70 text-xs mb-1">Status</div>
 <div className={`font-semibold text-lg ${status?.available ?'text-green-400' :'text-red-400'}`}>
 {status?.available ?'Connected' :'Unavailable'}
 </div>
 </div>
 <div className="bg-[#1a1a2e] rounded-xl border border-[rgb(var(--border))]/50 p-4">
 <div className="text-[rgb(var(--muted-foreground))]/70 text-xs mb-1">Features</div>
 ...
 <div key={f.name} className="p-4 rounded-lg bg-[rgb(var(--card))]/30 border border-[rgb(var(--border))]">
 <div className="flex items-center gap-2 mb-2">
 <span className="text-xl">{f.icon}</span>
 <span className="text-white font-medium">{f.name}</span>
 </div>
 <p className="text-xs text-[rgb(var(--muted-foreground))]/70">{f.desc}</p>
 </div>
 ))}
 </div>
 </div>
 ...
 :'bg-[rgb(var(--muted))]/10 border-[rgb(var(--border))] text-[rgb(var(--muted-foreground))]/70 hover:text-white'
 }`}
 >
 ...
 rows={4}
 className="w-full bg-[rgb(var(--card))]/50 border border-[rgb(var(--border))]/50 rounded-lg p-3 text-[rgb(var(--muted-foreground))]/40 text-sm resize-none focus:outline-none focus:border-purple-500/50 mb-3"
 />
 ...
 {/* Result */}
 {testResult && (
 <div className="mt-4 p-4 rounded-lg bg-[rgb(var(--card))]/50 border border-[rgb(var(--border))]/30">
 <h3 className="text-sm font-semibold text-[rgb(var(--muted-foreground))]/70 mb-2">Result</h3>
 <pre className="text-xs text-[rgb(var(--muted-foreground))]/50 whitespace-pre-wrap font-mono overflow-x-auto">
