...
const NavigationPage: React.FC = () => {
 ...
 method:'GET',
 headers: {'Content-Type':'application/json','Authorization': `Bearer ${AdminJWTBridge.getJWTToken()}`
 },
 });
 ...
 <div>
 <label className="mb-2 block text-sm font-semibold text-[rgb(var(--foreground))]">Name *</label>
 <input
 type="text"
 value={formState.name}
 onChange={(event) => handleFieldChange("name", event.target.value)}
 placeholder="e.g., home, news, opinion"
 className={`w-full rounded-xl border-2 ${formErrors.name ?'border-red-400 ring-1 ring-red-300' :'border-[rgb(var(--border))]'} bg-[rgb(var(--card))] px-4 py-3 text-[rgb(var(--foreground))] shadow-sm transition focus:border-[rgb(var(--primary))] focus:outline-none focus:ring-2 focus:ring-[rgb(var(--primary))]/30`}
 required
 ...
 <div>
 <label className="mb-2 block text-sm font-semibold text-[rgb(var(--foreground))]">Display Label *</label>
 <input
 type="text"
 value={formState.label}
 onChange={(event) => handleFieldChange("label", event.target.value)}
 placeholder="e.g., Home, News, Opinion"
 className="w-full rounded-xl border-2 border-[rgb(var(--border))] bg-[rgb(var(--card))] px-4 py-3 text-[rgb(var(--foreground))] shadow-sm transition focus:border-[rgb(var(--primary))] focus:outline-none focus:ring-2 focus:ring-[rgb(var(--primary))]/30"
 required
 />
 <p className="mt-2 text-xs text-[rgb(var(--muted-foreground))]">
 ...
 <div>
 <label className="mb-2 block text-sm font-semibold text-[rgb(var(--foreground))]">URL Path *</label>
 <input
 type="text"
 value={formState.href}
 onChange={(event) => handleFieldChange("href", event.target.value)}
 placeholder="e.g., /, /news, /opinion"
 className={`w-full rounded-xl border-2 ${formErrors.href ?'border-red-400 ring-1 ring-red-300' :'border-[rgb(var(--border))]'} bg-[rgb(var(--card))] px-4 py-3 text-[rgb(var(--foreground))] shadow-sm transition focus:border-[rgb(var(--primary))] focus:outline-none focus:ring-2 focus:ring-[rgb(var(--primary))]/30`}
 required
 disabled={editingItem?.isSystem}
 />
 {formErrors.href && (
 ...
 <div>
 <label className="mb-2 block text-sm font-semibold text-[rgb(var(--foreground))]">Icon</label>
 <input
 type="text"
 ...
 maxLength={10}
 className="w-full rounded-xl border-2 border-[rgb(var(--border))] bg-[rgb(var(--card))] px-4 py-3 text-center text-2xl text-[rgb(var(--foreground))] shadow-sm transition focus:border-[rgb(var(--primary))] focus:outline-none focus:ring-2 focus:ring-[rgb(var(--primary))]/30"
 />
 <p className="mt-2 text-xs text-[rgb(var(--muted-foreground))]">For quick visual identification in navigation.</p>
 </div>
 ...
 <button
 type="submit"
 className="rounded-xl bg-[rgb(var(--primary))] px-6 py-3 font-semibold text-white shadow-sm transition hover:opacity-90 disabled:opacity-50"
 disabled={isSubmitting}
 >
 ...
 className="ml-3 inline-flex items-center rounded-md bg-[rgb(var(--background))] px-3 py-2 text-sm font-medium text-[rgb(var(--foreground))] shadow-sm hover:bg-[rgb(var(--muted))]/30"
 >
 Sync categories
 </button>
 </div>
 ...
 <div>
 <h2 className="text-xl font-semibold text-[rgb(var(--foreground))]">Navigation Order</h2>
 ...
 <span className="h-10 w-10 animate-spin rounded-full border-2 border-[rgb(var(--primary))] border-t-transparent" />
 ...
 <div className="py-16 text-center">
 <p className="text-lg font-semibold text-[rgb(var(--muted-foreground))]">No navigation items yet</p>
 ...
 <div className="flex flex-col items-center gap-1">
 {item.isSystem && (
 <div className="rounded bg-[rgb(var(--primary))]/10 px-2 py-0.5 text-xs font-semibold text-[rgb(var(--primary))]">
 System
 </div>
 )}
 ...
 :'bg-[rgb(var(--muted))]/30 text-[rgb(var(--foreground))] /30'
 }`}>
 ...
 <div>
 <h3 className="text-xl font-semibold text-[rgb(var(--foreground))]">{item.label}</h3>
 <p className="text-xs text-[rgb(var(--muted-foreground))]">Name: {item.name}</p>
 </div>
 </div>
 <span
 ...
 {item.type ==='category' ? (
 <>Category: <code className="rounded bg-[rgb(var(--muted))]/10 px-2 py-1 font-mono">{item.name}</code></>
 ) : (
 <>Links to: <code className="rounded bg-[rgb(var(--muted))]/10 px-2 py-1 font-mono">{item.href}</code></>
 )}
 </p>
 ...
 <span className="font-mono text-sm text-[rgb(var(--foreground))]">#{item.sortOrder}</span>
 </div>
 <div className="flex items-center justify-between">
 <span className="text-[rgb(var(--muted-foreground))]">Created</span>
 <span className="text-sm text-[rgb(var(--foreground))]">{formatDate(item.createdAt || new Date().toISOString())}</span>
 </div>
 </div>
 ...
 {item.type ==='category' && (
 <div className="flex-1 rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--background))] px-4 py-2.5 text-sm font-semibold text-[rgb(var(--muted-foreground))]">
 ...
 className={`flex items-center justify-center rounded-xl border-2 border-dashed border-[rgb(var(--border))]/30 p-6 text-sm text-[rgb(var(--muted-foreground))] transition ${dragOverIndex === sortedNavigation.length ?'ring-2 ring-blue-500 ring-opacity-50' :''}`}
 >
...
const StatCard: React.FC<{ label: string; value: number; accent: string }> = ({ label, value, accent }) => (
 ...
 <p className="mt-2 text-3xl font-semibold text-[rgb(var(--foreground))]">{value}</p>
 </div>
);
