...
const TrashPage = () => {
 ...
 switch (type) {
 case'article':
 return'bg-[rgb(var(--primary))]/10 text-[rgb(var(--primary))]';
 case'category':
 ...
 default:
 return'bg-[rgb(var(--muted))]/30 text-[rgb(var(--foreground))] /20';
 }
 };
 ...
 return (
 <div className="p-6 text-[rgb(var(--foreground))]">
 ...
 className="flex items-center gap-2 px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 dark:bg-emerald-600 dark:hover:bg-emerald-700 transition-colors"
 >
 ...
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-lg shadow-sm">
 {/* Search and Filter */}
 <div className="p-4 border-b border-[rgb(var(--border))]">
 <div className="flex gap-4">
 <div className="flex-1">
 <div className="relative">
 <Search className="h-4 w-4 absolute left-3 top-3 text-[rgb(var(--muted-foreground))]" />
 <input
 type="text"
 placeholder="Search trash..."
 className="w-full pl-10 pr-4 py-2 border border-[rgb(var(--border))] rounded-lg focus:ring-2 focus:ring-primary focus:border-[rgb(var(--primary))] bg-[rgb(var(--background))] text-[rgb(var(--foreground))]"
 value={searchTerm}
 ...
 <div className="relative">
 <Filter className="h-4 w-4 absolute left-3 top-3 text-[rgb(var(--muted-foreground))]" />
 <select
 className="pl-10 pr-8 py-2 border border-[rgb(var(--border))] rounded-lg focus:ring-2 focus:ring-primary focus:border-[rgb(var(--primary))] appearance-none bg-[rgb(var(--background))] text-[rgb(var(--foreground))]"
 value={filterType}
 ...
 <Trash2 className="h-12 w-12 text-[rgb(var(--muted-foreground))] mx-auto mb-4" />
 ...
 className="rounded border-[rgb(var(--border))] text-[rgb(var(--primary))] focus:ring-primary"
 />
 </th>
 <th className="px-6 py-3 text-left text-xs font-medium text-[rgb(var(--muted-foreground))] uppercase tracking-wider">
 Item
 ...
 <tr key={item.id} className="hover:bg-[rgb(var(--muted))]/5">
 ...
 <td className="px-6 py-4 whitespace-nowrap text-sm text-[rgb(var(--muted-foreground))]">
