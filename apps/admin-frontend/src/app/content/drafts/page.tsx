...
const Drafts: React.FC = () => {
 ...
 <div className="h-8 bg-[rgb(var(--muted))] rounded w-1/4 mb-6"></div>
 <div className="space-y-4">
 {[...Array(3)].map((_, i) => (
 <div key={i} className="h-24 bg-[rgb(var(--muted))] rounded-lg"></div>
 ))}
 </div>
 </div>
 </div>
 ...
 <div className="bg-[rgb(var(--card))] rounded-xl shadow-sm p-8 border border-[rgb(var(--border))]/50 mt-6">
 {/* Header */}
 ...
 className="px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-xl hover:from-purple-700 hover:to-purple-800 transition-all duration-200 font-medium shadow-sm"
 >
 New Web Story
 </Link>
 </div>
 ...
 className="w-full px-4 py-2 border border-[rgb(var(--border))]/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-[rgb(var(--primary))]"
 />
 </div>
 <select
 value={filterCategory}
 onChange={(e) => setFilterCategory(e.target.value)}
 className="px-4 py-2 border border-[rgb(var(--border))]/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-[rgb(var(--primary))]"
 >
 ...
 <div className="flex items-center gap-4 mb-6 p-4 bg-[rgb(var(--primary))]/5 rounded-lg border border-[rgb(var(--primary))]/20">
 ...
 className="px-4 py-2 border border-[rgb(var(--border))]/30 rounded hover:bg-[rgb(var(--background))] transition-colors"
 >
 Clear Selection
 </button>
 </div>
 ...
 <h3 className="text-xl font-medium text-[rgb(var(--foreground))] mb-2">
 No drafts found
 </h3>
 ...
 <Link
 href="/content/new"
 className="inline-flex items-center px-6 py-3 bg-[rgb(var(--primary))] text-white rounded-xl hover:opacity-90 transition-all duration-200 font-medium"
 >
 Create New Article
 </Link>
 </div>
 ...
 <div className="flex items-center gap-4 p-4 bg-[rgb(var(--background))] rounded-lg border border-[rgb(var(--border))]/30">
 <input
 type="checkbox"
 ...
 <div
 key={draft.id}
 className="flex items-start gap-4 p-6 border border-[rgb(var(--border))]/30 rounded-lg hover:border-blue-300 transition-colors"
 >
 <input
 type="checkbox"
 checked={selectedDrafts.includes(draft.id)}
 onChange={() => toggleDraftSelection(draft.id)}
 className="w-4 h-4 text-[rgb(var(--primary))] mt-1"
 />
 
 <div className="flex-1 min-w-0">
 <div className="flex items-start justify-between mb-2">
 <Link
 href={draft.type ==='webstory' ? `/content/web-stories` : `/content/new?id=${draft.id}`}
 className="text-xl font-semibold text-[rgb(var(--foreground))] hover:text-[rgb(var(--primary))] transition-colors line-clamp-2"
 >
 {draft.title}
 </Link>
 ...
 {draft.type ==='article' && (
 <span className="px-2 py-1 text-xs bg-[rgb(var(--primary))]/10 text-[rgb(var(--primary))] rounded-full">
 Article
 </span>
 )}
 {draft.autoSaved && (
 ...
 <span className="px-2 py-1 text-xs bg-[rgb(var(--muted))]/30 text-[rgb(var(--foreground))] rounded-full">
 {draft.status}
 </span>
 </div>
 </div>

 <p className="text-[rgb(var(--muted-foreground))] text-sm line-clamp-2 mb-3">
 {draft.type ==='webstory' 
 ...
 <span
 key={tag}
 className="px-2 py-1 text-xs bg-[rgb(var(--primary))]/5 text-[rgb(var(--primary))] rounded-full"
 >
 {tag}
 </span>
 ))}
 {draft.tags.length > 5 && (
 <span className="px-2 py-1 text-xs bg-[rgb(var(--muted))]/30 text-[rgb(var(--muted-foreground))] rounded-full">
 ...
 <Link
 href={draft.type ==='webstory' ? `/content/web-stories` : `/content/new?id=${draft.id}`}
 className="px-4 py-2 text-sm bg-[rgb(var(--primary))] text-white rounded hover:opacity-90 transition-colors text-center"
 >
 Edit
 </Link>
 <button
