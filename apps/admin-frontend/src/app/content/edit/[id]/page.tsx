...
// Dynamically import AdvancedNewsEditor client-side only
const AdvancedNewsEditor = dynamic(() => import('@/components/editors/AdvancedNewsEditor'), {
 ...
 <span className="ml-3 text-[rgb(var(--muted-foreground))]">Loading editor...</span>
 </div>
 </div>
 ),
});
...
const EditArticle: React.FC = () => {
 ...
 router.push(`/content?success=${encodeURIComponent(`Article ${statusText} successfully!`)}`);
 } else {
 ...
 <span className="ml-3 text-[rgb(var(--muted-foreground))]">Loading article...</span>
 </div>
 </div>
 );
 }
 ...
 <h2 className="text-2xl font-bold text-[rgb(var(--muted-foreground))] mb-2">Error Loading Article</h2>
 <p className="text-[rgb(var(--muted-foreground))] mb-6">{error}</p>
 <Link
 href="/admin/content"
 className="px-6 py-3 bg-[rgb(var(--primary))] text-white rounded-xl hover:opacity-90 transition-colors"
 >
 ← Back to Content
 </Link>
 </div>
 ...
 <Link
 href="/admin/content"
 className="px-6 py-3 bg-[rgb(var(--muted))]/30 hover:bg-[rgb(var(--muted))]/50 text-[rgb(var(--foreground))] rounded-xl transition-all duration-300"
 >
 ← Back to Content
 </Link>
 </div>
 ...
 className="w-full px-4 py-3 border border-[rgb(var(--border))]/50 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-[rgb(var(--card))] text-[rgb(var(--foreground))] text-lg"
 ...
 className="w-full px-4 py-3 border border-[rgb(var(--border))]/50 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-[rgb(var(--card))] text-[rgb(var(--foreground))] resize-none"
 rows={3}
 ...
 onChange={(html: string) => handleInputChange('content', html)}
 showWordTarget={true}
 wordTarget={800}
 autoSave={true}
 />
 ...
 className="w-full px-4 py-3 border border-[rgb(var(--border))]/50 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-[rgb(var(--card))] text-[rgb(var(--foreground))]"
 >
 ...
 {formData.excerpt && <p className="text-lg text-[rgb(var(--muted-foreground))]">{formData.excerpt}</p>}
 ...
 {/* Action Buttons */}
 <div className="p-8 border-t border-[rgb(var(--border))]/50 bg-[rgb(var(--background))]">
 ...
 disabled={saving}
 className="px-6 py-3 bg-[rgb(var(--muted))]/50 hover:bg-[rgb(var(--border))] text-[rgb(var(--foreground))] rounded-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
 >
 ...
 disabled={saving}
 className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed font-semibold shadow-sm"
 >
