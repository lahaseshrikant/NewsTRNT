...
const ScrapedItemsPage: React.FC = () => {
 ...
 <h1 className="text-2xl font-semibold tracking-tight">Scraped Items</h1>
 {loading ? (
 <div>Loading…</div>
 ) : (
 <>
 <table className="min-w-full bg-[rgb(var(--card))]">
 <thead>
 <tr>
 ...
 <td className="px-4 py-2">
 {!it.isApproved && (
 <button onClick={() => approve(it.id)} className="px-2 py-1 bg-emerald-600 text-white rounded">
 Approve
 </button>
 )}
 </td>
