...
function ActivityMonitorContent() {
 ...
 <span>/</span>
 <span className="text-[rgb(var(--foreground))]">Activity Monitor</span>
 </div>
 ...
 :'bg-[rgb(var(--card))] border border-[rgb(var(--border))] text-[rgb(var(--foreground))]'
 }`}
 >
 <span className={`w-2 h-2 rounded-full ${isLive ?'bg-white animate-pulse' :'bg-[rgb(var(--muted-foreground))]/60'}`}></span>
 {isLive ?'Live' :'Paused'}
 </button>
 <button
 onClick={loadData}
 ...
 <div>
 <p className="text-sm text-[rgb(var(--muted-foreground))]">Today's Actions</p>
 <p className="text-2xl font-semibold tracking-tight text-[rgb(var(--foreground))]">{stats.totalActions}</p>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-[rgb(var(--muted-foreground))]">Active Users</p>
 <p className="text-2xl font-semibold tracking-tight text-green-600">{stats.activeUsers}</p>
 </div>
 <span className="text-3xl">👥</span>
 </div>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-[rgb(var(--muted-foreground))]">Actions/Hour</p>
 <p className="text-2xl font-semibold tracking-tight text-[rgb(var(--primary))]">{stats.actionsPerHour}</p>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-[rgb(var(--muted-foreground))]">Security Alerts</p>
 <p className={`text-2xl font-semibold tracking-tight ${stats.securityAlerts > 0 ?'text-red-600' :'text-green-600'}`}>
 ...
 <h2 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Activity Over 24 Hours</h2>
 ...
 isCurrentHour 
 ?'bg-[rgb(var(--primary))]' 
 :'bg-blue-400 hover:bg-[rgb(var(--primary))]/50'
 }`}
 style={{ height: `${height}%` }}
 ...
 <h2 className="text-lg font-semibold text-[rgb(var(--foreground))]">Live Activity Feed</h2>
 {isLive && (
 ...
 activity.isLive 
 ?'bg-[rgb(var(--primary))]/5 border border-[rgb(var(--primary))]/20' 
 :'bg-muted/30 hover:bg-[rgb(var(--muted))]/5'
 }`}
 >
 ...
 <span className={`text-xs ${roleConfig?.color ||'text-[rgb(var(--muted-foreground))]'}`}>
 {roleConfig?.icon ||'👤'}
 </span>
 </div>
 ...
 {/* Active Sessions */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <h2 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Active Sessions</h2>
 ...
 <div 
 key={session.id}
 className="flex items-center gap-4 p-3 bg-[rgb(var(--muted))]/30 rounded-lg hover:bg-[rgb(var(--muted))]/5 transition-colors"
 >
 ...
 <h3 className="text-sm font-medium text-[rgb(var(--foreground))] mb-3">Sessions by Role</h3>
 ...
 <span 
 key={role}
 className={`px-3 py-1 rounded-full text-xs font-medium ${roleConfig?.bgColor ||'bg-[rgb(var(--muted))]/30'} ${roleConfig?.color ||'text-[rgb(var(--muted-foreground))]'}`}
 >
 ...
 {/* Action Distribution */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <h2 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Action Distribution (Today)</h2>
 ...
 <div key={action} className="text-center p-4 bg-[rgb(var(--muted))]/30 rounded-lg">
 <span className="text-2xl">{data.icon}</span>
 <p className="text-2xl font-bold text-[rgb(var(--foreground))] mt-2">{data.count}</p>
 <p className="text-xs text-[rgb(var(--muted-foreground))]">{action.replace(/_/g,'')}</p>
 </div>
 ));
 })()}
 </div>
