...
function SecuritySettingsContent() {
 ...
 <span>/</span>
 <span className="text-[rgb(var(--foreground))]">Security Settings</span>
 </div>
 ...
 onClick={handleSave}
 disabled={saving}
 className="px-6 py-2 bg-[rgb(var(--primary))] text-white rounded-lg hover:opacity-90 transition-colors disabled:opacity-50 flex items-center gap-2"
 >
 {saving ? (
 <>
 ...
 <div>
 <h2 className="text-lg font-semibold text-[rgb(var(--foreground))]">Security Score</h2>
 <p className="text-sm text-[rgb(var(--muted-foreground))]">Based on your current configuration</p>
 </div>
 <div className="flex items-center gap-4">
 <div className="text-center">
 <div className="text-4xl font-bold text-green-600">85</div>
 <div className="text-xs text-[rgb(var(--muted-foreground))]">/ 100</div>
 </div>
 ...
 <span className="text-sm text-[rgb(var(--foreground))] ml-2">MFA Available</span>
 </div>
 <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
 <span className="text-green-600">✓</span>
 <span className="text-sm text-[rgb(var(--foreground))] ml-2">Strong Password Policy</span>
 </div>
 <div className="p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
 <span className="text-yellow-600">⚠</span>
 <span className="text-sm text-[rgb(var(--foreground))] ml-2">MFA Not Enforced</span>
 </div>
 <div className="p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
 <span className="text-yellow-600">⚠</span>
 <span className="text-sm text-[rgb(var(--foreground))] ml-2">IP Whitelist Disabled</span>
 </div>
 </div>
 </div>
 ...
 :'bg-[rgb(var(--card))] border border-[rgb(var(--border))] hover:bg-[rgb(var(--muted))]/10'
 }`}
 >
 <span>{tab.icon}</span>
 <span>{tab.label}</span>
 ...
 {/* Content */}
 <div className="flex-1 bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 {/* MFA Settings */}
 {activeTab ==='mfa' && (
 ...
 <label key={method} className="flex items-center gap-3 p-3 bg-[rgb(var(--muted))]/30 rounded-lg cursor-pointer hover:bg-[rgb(var(--muted))]/5">
 <input
 type="checkbox"
 ...
 <label className="flex items-center gap-3 p-4 bg-[rgb(var(--muted))]/30 rounded-lg cursor-pointer hover:bg-[rgb(var(--muted))]/5">
 <input
 type="checkbox"
 ...
 />
 <div>
 <p className="font-medium text-[rgb(var(--foreground))]">Require Re-authentication for Sensitive Actions</p>
 <p className="text-xs text-[rgb(var(--muted-foreground))]">
 ...
 <label key={req.key} className="flex items-center gap-3 p-3 bg-[rgb(var(--muted))]/30 rounded-lg cursor-pointer hover:bg-[rgb(var(--muted))]/5">
 <input
 type="checkbox"
 ...
 className="rounded border-[rgb(var(--border))]"
 />
 <span className="text-[rgb(var(--foreground))]">{req.label}</span>
 </label>
 ))}
 </div>
 ...
 />
 <div>
 <p className="font-medium text-[rgb(var(--foreground))]">Enable IP Whitelist</p>
 <p className="text-xs text-[rgb(var(--muted-foreground))]">
 ...
 className="flex-1 px-4 py-2 bg-[rgb(var(--background))] border border-[rgb(var(--border))] rounded-lg focus:ring-2 focus:ring-[rgb(var(--primary))]"
 />
 <button
 ...
 <div key={ip} className="flex items-center justify-between p-3 bg-[rgb(var(--muted))]/30 rounded-lg">
 <code className="text-[rgb(var(--foreground))]">{ip}</code>
 <button
 ...
 />
 <div>
 <p className="font-medium text-[rgb(var(--foreground))]">Block VPN/Proxy Connections</p>
 <p className="text-xs text-[rgb(var(--muted-foreground))]">
 ...
 />
 <div>
 <p className="font-medium text-[rgb(var(--foreground))]">Require Email Verification</p>
 <p className="text-xs text-[rgb(var(--muted-foreground))]">
 ...
 <label key={alert.key} className="flex items-center gap-3 p-4 bg-[rgb(var(--muted))]/30 rounded-lg cursor-pointer hover:bg-[rgb(var(--muted))]/5">
 <input
 type="checkbox"
 ...
 />
 <div>
 <p className="font-medium text-[rgb(var(--foreground))]">{alert.label}</p>
 <p className="text-xs text-[rgb(var(--muted-foreground))]">{alert.desc}</p>
 </div>
 </label>
 ))}
 </div>
