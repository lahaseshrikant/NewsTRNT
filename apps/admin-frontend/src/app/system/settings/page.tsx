...
function SystemSettingsContent() {
 ...
 <div>
 <h1 className="text-2xl font-bold text-[rgb(var(--foreground))]">System Settings</h1>
 <p className="text-[rgb(var(--muted-foreground))]">Configure security, notifications, and content policies</p>
 </div>
 ...
 className="px-4 py-2 bg-[rgb(var(--primary))] text-white rounded-lg hover:opacity-90 transition-colors disabled:opacity-50"
 >
 ...
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Multi-Factor Authentication</h3>
 <div className="space-y-4">
 <div>
 <label className="block text-sm font-medium text-[rgb(var(--foreground))] mb-2">MFA Enforcement Level</label>
 <select
 value={settings.security.mfaEnforcement}
 onChange={(e) => updateSettings('security','mfaEnforcement', e.target.value)}
 className="w-full md:w-64 px-3 py-2 rounded-lg border border-[rgb(var(--border))] bg-[rgb(var(--background))] text-[rgb(var(--foreground))]"
 >
 ...
 {/* Session Settings */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Session Management</h3>
 <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
 <div>
 <label className="block text-sm font-medium text-[rgb(var(--foreground))] mb-1">Session Timeout (minutes)</label>
 <input
 type="number"
 min={15}
 max={1440}
 ...
 className="w-full px-3 py-2 rounded-lg border border-[rgb(var(--border))] bg-[rgb(var(--background))] text-[rgb(var(--foreground))]"
 />
 </div>
 <div>
 <label className="block text-sm font-medium text-[rgb(var(--foreground))] mb-1">Max Login Attempts</label>
 <input
 type="number"
 min={3}
 max={10}
 ...
 <div>
 <label className="block text-sm font-medium text-[rgb(var(--foreground))] mb-1">Lockout Duration (minutes)</label>
 <input
 type="number"
 min={5}
 max={60}
 ...
 {/* Password Policy */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Password Policy</h3>
 <div className="space-y-4">
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div>
 <label className="block text-sm font-medium text-[rgb(var(--foreground))] mb-1">Minimum Length</label>
 <input
 type="number"
 min={6}
 max={32}
 ...
 <div>
 <label className="block text-sm font-medium text-[rgb(var(--foreground))] mb-1">Prevent Reuse (last N passwords)</label>
 <input
 type="number"
 min={0}
 max={24}
 ...
 {/* IP Whitelist */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">IP Whitelist</h3>
 ...
 className="flex-1 px-3 py-2 rounded-lg border border-[rgb(var(--border))] bg-[rgb(var(--background))] text-[rgb(var(--foreground))]"
 />
 <button
 onClick={() => {
 ...
 className="px-4 py-2 bg-[rgb(var(--primary))] text-white rounded-lg hover:opacity-90"
 >
 Add
 </button>
 </div>
 ...
 <span key={ip} className="flex items-center gap-2 px-3 py-1 bg-[rgb(var(--muted))]/10 rounded-full text-sm">
 {ip}
 <button
 ...
 <span className="text-sm text-[rgb(var(--muted-foreground))]">No IP restrictions (all IPs allowed)</span>
 )}
 </div>
 </div>
 </div>
 ...
 {/* Alert Channels */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Notification Channels</h3>
 <div className="space-y-4">
 <label className="flex items-center justify-between p-3 bg-[rgb(var(--muted))]/5 rounded-lg cursor-pointer">
 <div>
 <p className="font-medium text-[rgb(var(--foreground))]">Email Notifications</p>
 <p className="text-sm text-[rgb(var(--muted-foreground))]">Receive alerts via email</p>
 </div>
 <input
 type="checkbox"
 checked={settings.notifications.emailEnabled}
 onChange={(e) => updateSettings('notifications','emailEnabled', e.target.checked)}
 className="rounded border-[rgb(var(--border))] w-5 h-5"
 />
 </label>
 <label className="flex items-center justify-between p-3 bg-[rgb(var(--muted))]/5 rounded-lg cursor-pointer">
 <div>
 <p className="font-medium text-[rgb(var(--foreground))]">Slack Notifications</p>
 <p className="text-sm text-[rgb(var(--muted-foreground))]">Send alerts to Slack channel</p>
 </div>
 <input
 type="checkbox"
 ...
 <div className="ml-4">
 <label className="block text-sm font-medium text-[rgb(var(--foreground))] mb-1">Slack Webhook URL</label>
 <input
 type="url"
 ...
 {/* Alert Types */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Alert Types</h3>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 {[
 ...
 <label key={key} className="flex items-start gap-3 p-3 bg-[rgb(var(--muted))]/5 rounded-lg cursor-pointer">
 <input
 type="checkbox"
 ...
 className="rounded border-[rgb(var(--border))] mt-1"
 />
 <div>
 ...
 {/* Alert Thresholds */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Alert Thresholds</h3>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div>
 ...
 {/* Auto-Save & Uploads */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Auto-Save & Uploads</h3>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div>
 <label className="block text-sm font-medium text-[rgb(var(--foreground))] mb-1">Auto-Save Interval (seconds)</label>
 <input
 type="number"
 min={10}
 max={300}
 ...
 <div>
 <label className="block text-sm font-medium text-[rgb(var(--foreground))] mb-1">Max Upload Size (MB)</label>
 <input
 type="number"
 min={1}
 max={100}
 ...
 {/* Allowed File Types */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Allowed File Types</h3>
 <div className="flex gap-2 mb-4">
 <input
 type="text"
 ...
 <span key={type} className="flex items-center gap-2 px-3 py-1 bg-[rgb(var(--muted))]/10 rounded-full text-sm">
 .{type}
 <button
 ...
 {/* Content Workflow */}
 <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-xl p-6">
 <h3 className="text-lg font-semibold text-[rgb(var(--foreground))] mb-4">Content Workflow</h3>
 <div className="space-y-4">
 <div>
 <label className="block text-sm font-medium text-[rgb(var(--foreground))] mb-1">Default Article Status</label>
 <select
 ...
 <label className="flex items-center justify-between p-3 bg-[rgb(var(--muted))]/5 rounded-lg cursor-pointer">
 <div>
 <p className="font-medium text-[rgb(var(--foreground))]">Require Approval for Publishing</p>
 <p className="text-sm text-[rgb(var(--muted-foreground))]">Articles must be approved before publishing</p>
 </div>
 <input
 type="checkbox"
 ...
 <div>
 <label className="block text-sm font-medium text-[rgb(var(--foreground))] mb-2">Roles That Can Approve</label>
 <div className="flex flex-wrap gap-2">
 {ROLE_HIERARCHY.map(role => (
 <label key={role} className="flex items-center gap-2 px-3 py-1 bg-[rgb(var(--muted))]/10 rounded-full cursor-pointer">
 <input
 type="checkbox"
 ...
 <label className="flex items-center justify-between p-3 bg-[rgb(var(--muted))]/5 rounded-lg cursor-pointer">
 <div>
 <p className="font-medium text-[rgb(var(--foreground))]">Auto‑promote scraped articles</p>
 <p className="text-sm text-[rgb(var(--muted-foreground))]">When enabled, content engine scraps are automatically moved into the live articles table.</p>
 </div>
 <input
 type="checkbox"
