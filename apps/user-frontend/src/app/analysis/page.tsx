...
const AnalysisPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <section className="hero-analysis border-b-2 border-vermillion">
        <div className="relative z-10 container mx-auto py-10">
          <div className="max-w-4xl">
            <span className="font-mono text-xs tracking-[0.2em] uppercase opacity-70 mb-3 block">Deep Dives</span>
