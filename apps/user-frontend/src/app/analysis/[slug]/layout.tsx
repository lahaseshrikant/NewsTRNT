...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      article.summary ||
      `Expert analysis: "${article.title}" — in-depth commentary on NewsTRNT.`,
...
export default async function AnalysisSlugLayout({
  children,
  params,
}: {
  ...
  const jsonLd = article
    ? {
        ...
        mainEntityOfPage: {
          "@type": "WebPage",
          "@id": `${process.env.NEXT_PUBLIC_SITE_URL || "https://newstrnt.com"}/analysis/${slug}`,
        },
