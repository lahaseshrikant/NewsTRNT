      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex gap-2">
              {[
                ...
                <a
                  ...
                  className={`w-9 h-9 border border-ivory/10 rounded-lg flex items-center justify-center text-ivory/40 ${social.hoverColor} transition-all`}
                  title={social.name}
                >
                  {social.icon}
                </a>
            ...
            {/* App Download CTA — Coming Soon */}
            <div className="mt-6 pt-6 border-t border-ivory/8">
              <p className="text-xs text-ivory/30 font-mono uppercase tracking-widest mb-3">App Coming Soon</p>
              <div className="flex gap-2">
                <div className="flex items-center gap-2 px-3 py-2 bg-ivory/5 border border-ivory/10 rounded-lg opacity-50 cursor-not-allowed">
                  <svg className="w-5 h-5 text-ivory/50" viewBox="0 0 24 24" fill="currentColor"><path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/></svg>
            ...
            <ul className="space-y-2.5">
              {sectionLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-sm text-ivory/60 hover:text-ivory hover:translate-x-1 inline-block transition-all duration-200"
                  >
                    {link.name}
                  </Link>
                </li>
